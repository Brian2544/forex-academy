        ...
        <div className="mb-12 text-center relative">
          ...
          <div className="relative">
            <h1 className="text-5xl font-bold text-white mb-4">
              <span className="bg-gradient-to-r from-primary-500 via-accent-500 to-primary-500 bg-clip-text text-transparent animate-pulse">Professionals</span> Portal
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {traineeSections.map((section, index) => (
            ...
            >
              ...
              >
                <div className="card h-full cursor-pointer hover:border-accent-500 hover:shadow-xl transition-all duration-300 group">
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 rounded-lg gradient-gold flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      {(() => {
                  ...
                  <div className="mt-auto flex items-center text-accent-600 text-sm font-medium group-hover:gap-2 transition-all">
