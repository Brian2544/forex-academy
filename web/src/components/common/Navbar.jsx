      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              <>
                <Link to="/student/dashboard" className="text-slate-300 hover:text-amber-400 transition font-medium relative group">
                  My Portal
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-amber-400 group-hover:w-full transition-all duration-300"></span>
                </Link>
              ...
              <>
                <Link to="/login" className="text-slate-300 hover:text-amber-400 transition font-medium relative group">
                  Login
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-amber-400 group-hover:w-full transition-all duration-300"></span>
                </Link>
                <Link to="/register" className="px-6 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-slate-900 font-bold rounded-lg hover:shadow-lg hover:shadow-amber-500/40 hover:-translate-y-0.5 transition-all duration-300">
                  Sign Up
                </Link>
              </>
            )}
            ...
            <div className="flex flex-col space-y-4">
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link to="/register" className="px-6 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-slate-900 font-bold rounded-lg text-center">
                    Sign Up
                  </Link>
                </>
              )}
